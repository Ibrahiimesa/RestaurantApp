...
class NotificationHelper {
  ...
  Future<void> initNotifications(
    ...
    await flutterLocalNotificationsPlugin.initialize(initializationSettings,
      ...
      if (payload != null) {
        ...
        await Navigation.intentWithData(RestaurantDetail.routeName, data);
      }
  ...
  Future<void> showNotification(
      ...
      RestaurantResponse restaurantList) async {
    var channelId = "1";
    ...
    var restaurant = restaurantList.restaurants[randomRestaurant];
    debugPrint(json.encode(restaurant.toJson()));

    await flutterLocalNotificationsPlugin.show(
        0, titleNotification, restaurant.name, platformChannelSpecifics,
